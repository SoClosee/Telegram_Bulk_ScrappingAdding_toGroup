# Bot Telegram Bulk Scrapping and Adding to a Public Group:
Le Bot permet de scrapper les informations utilisateurs dans les groupes telegram Public puis de les ajouter dans l'un de vos groupes en masse avec plusieurs comptes en meme temps.
...
* Scrapping et Ajout en simultané sur plusieurs comptes.
...
* Ajouter les identifiants Api Telegram dans chaque dossier BotX/add1.py:
```python
api_id = XXXXXX
...
* Le bot tourne, faire ca pour chacun. 
